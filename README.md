<h1 align="center">Hi 👋, I'm Rahma Radwan</h1>
<h3 align="center">A Passionate Frontend Developer from Egypt</h3>

<p align="center">
  I'm a motivated Frontend Developer focused on building modern, responsive web applications using React.  
  I have strong experience in JavaScript and TypeScript, with expertise in state management using Redux and UI libraries like Tailwind CSS and Bootstrap.  
  I love crafting clean user interfaces and continuously learning new tools to improve user experience and development flow.
</p>
...
<ul>
  <li><strong>Personal Portfolio Website</strong> – Designed and built with React, TailwindCSS, and responsive animations. Hosted on Vercel.</li>
  <li><strong>Course Dashboard UI</strong> – A dynamic frontend interface for managing courses using Redux Toolkit and custom components.</li>
  <li><strong>Multi-language Educational Site</strong> – Built with React i18next, supporting Arabic and English, styled with Bootstrap and Tailwind.</li>
</ul>
...
<ul>
  ...
  <li><strong>Frameworks/Libraries:</strong> React, Redux, Bootstrap, TailwindCSS</li>
  <li><strong>Tools:</strong> Git, GitHub, VS Code</li>
  <li><strong>Extras:</strong> Formik, Yup, i18next, Responsive Design</li>
</ul>
